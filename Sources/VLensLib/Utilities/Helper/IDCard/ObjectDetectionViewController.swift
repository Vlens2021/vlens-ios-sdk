...
public class ObjectDetectionViewController: UIViewController, CardDetectionSessionHandlerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    let sessionHandler = VObjectDetectionSessionHandler()
    ...
    nonisolated func sessionHandler(_ handler: VObjectDetectionSessionHandler, didDetectCardInImage image: CGImage, withTopLeftCorner topLeftCorner: CGPoint, topRightCorner: CGPoint, bottomRightCorner: CGPoint, bottomLeftCorner: CGPoint, perspectiveCorrectionParams: [String:CIVector], sharpness: Float?) {
        
    }
    
    nonisolated func sessionHandler(_ handler: VObjectDetectionSessionHandler, didDetectBarcodes barcodes: [VNBarcodeObservation]) {
        
    }
    
    nonisolated func shouldDetectBarcodeWithSessionHandler(_ handler: VObjectDetectionSessionHandler) -> Bool {
        return false
    }
    
    nonisolated func shouldDetectCardImageWithSessionHandler(_ handler: VObjectDetectionSessionHandler) -> Bool {
        return false
    }
