//
//  VObjectDetectionSessionHandler.swift
//  VLensLib
//
//  Created by Mohamed Taher on 06/08/2025.
//
...
class VObjectDetectionSessionHandler: NSObject, @unchecked Sendable, AVCaptureVideoDataOutputSampleBufferDelegate {
...
protocol CardDetectionSessionHandlerDelegate: AnyObject, Sendable {
    func sessionHandler(_ handler: VObjectDetectionSessionHandler, didDetectCardInImage image: CGImage, withTopLeftCorner topLeftCorner: CGPoint, topRightCorner: CGPoint, bottomRightCorner: CGPoint, bottomLeftCorner: CGPoint, perspectiveCorrectionParams: [String:CIVector], sharpness: Float?)
    func sessionHandler(_ handler: VObjectDetectionSessionHandler, didDetectBarcodes barcodes: [VNBarcodeObservation])
    func shouldDetectCardImageWithSessionHandler(_ handler: VObjectDetectionSessionHandler) -> Bool
    func shouldDetectBarcodeWithSessionHandler(_ handler: VObjectDetectionSessionHandler) -> Bool
}
